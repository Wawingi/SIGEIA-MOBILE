...
public class Fau7 extends Fragment {
    View view;
    ListView lv;
    ...
    private ArrayList<Curso> adicionarCursos(){
        ...
        curso = new Curso("Análises Clínicas","Morro Bento");
        cursos.add(curso);
        curso = new Curso("Ciências de Enfermagem","Morro Bento");
        cursos.add(curso);
        curso = new Curso("Ciências Farmacêuticas","Morro Bento");
        cursos.add(curso);
        curso = new Curso("Psicologia Clínica","Morro Bento");
        cursos.add(curso);
        curso = new Curso("Psicologia Escolar","Morro Bento");
        cursos.add(curso);
